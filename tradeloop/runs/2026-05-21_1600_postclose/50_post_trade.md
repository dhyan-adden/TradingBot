...
- Run: `tradeloop/runs/2026-05-21_1600_postclose`
- Mode: `postclose`
...
- Runs visible since the prior postclose:
  `tradeloop/runs/2026-05-21_1230_intraday` and this run both have empty order
  and fill ledgers.
- No `2026-05-21_0800_premarket` run is present in `tradeloop/runs`.
...
- `carry_forward_context.md`: existing RELIANCE watch levels remain sufficient.
