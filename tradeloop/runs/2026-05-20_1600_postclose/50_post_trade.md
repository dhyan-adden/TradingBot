...
- Run: `tradeloop/runs/2026-05-20_1600_postclose`
- Mode: `postclose`
...
- Runs visible since the prior postclose:
  `tradeloop/runs/2026-05-20_0800_premarket`,
  `tradeloop/runs/2026-05-20_1230_intraday`, and this run all have empty
